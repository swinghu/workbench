...
public class TemperatureAveragingPair implements Writable,
		WritableComparable<TemperatureAveragingPair> {
	...
	public static TemperatureAveragingPair read(DataInput in)
			throws IOException {
	...
	public String toString() {
		return "TemperatureAveragingPair{" + "temp=" + temp + ", count="
				+ count + '}';
	}
