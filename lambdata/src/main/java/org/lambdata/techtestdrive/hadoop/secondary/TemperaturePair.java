...
public class TemperaturePair implements Writable,
		WritableComparable<TemperaturePair> {
	...
	public int compareTo(TemperaturePair temperaturePair) {
		int compareValue = this.yearMonth.compareTo(temperaturePair
				.getYearMonth());
		if (compareValue == 0) {
			compareValue = temperature.compareTo(temperaturePair
					.getTemperature());
		}
		return compareValue;
	}
	...
	public boolean equals(Object o) {
		...
		if (temperature != null ? !temperature.equals(that.temperature)
				: that.temperature != null)
			return false;
		if (yearMonth != null ? !yearMonth.equals(that.yearMonth)
				: that.yearMonth != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (temperature != null ? temperature.hashCode() : 0);
		return result;
	}

	@Override
	public String toString() {
		return "TemperaturePair{" + "yearMonth=" + yearMonth + ", temperature="
				+ temperature + '}';
	}
}
