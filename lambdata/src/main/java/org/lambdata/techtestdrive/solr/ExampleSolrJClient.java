package org.lambdata.techtestdrive.solr;
...
public class ExampleSolrJClient {
	...
	public void runExample() throws Exception {
		...
		doc1.setField(
				"text_t",
				"#Yummm :) Drinking a latte at Caffe Grecco in SF's"
		...
		doc2.setField(
				"text_t",
				"Just downloaded the MEAP for #SolrInAction from"
	...
	SolrDocumentList simpleSolrQuery(SolrServer solr, String query, int rows)
	...
	public static void main(String[] args) throws Exception {
		new ExampleSolrJClient().runExample();
	}
}
